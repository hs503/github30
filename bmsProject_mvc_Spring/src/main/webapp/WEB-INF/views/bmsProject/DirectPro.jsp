...
<body>
	...
	<c:if test="${sessionScope.memId!=null}">
		<div style="margin:0 auto; width:800px;">
			<form action="DirectBy.bo" method="post" name="buyForm">
				...
				<table>
					...
					<tr>
						<td colspan="2">
							...
							<input type="button" value="배송지 변경" onclick="window.location='DirectPro.bo?image=${image}&code=${code}&amount=${amount}&price=${price}&title=${title}&addrChange=1'">
						</td>
					</tr>
	...
	<c:if test="${sessionScope.memId==null}">
		<div style="margin:0 auto; width:800px;">
		<form action="DirectBy.bo" method="post" name="gestAddrForm">
			<input type="hidden" name="code" value="${code}">
			<input type="hidden" name="image" value="${image}">
			<input type="hidden" name="title" value="${title}">
			<input type="hidden" name="amount" value="${amount}">
		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<select name="email3" onchange="return emailCheck(this.form)">
